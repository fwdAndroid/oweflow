...
class EditLendPage extends StatefulWidget {
  final Map<String, dynamic> document;

  const EditLendPage({super.key, required this.document});

  @override
  State<EditLendPage> createState() => _EditLendPageState();
}

class _EditLendPageState extends State<EditLendPage> {
