...
class LendersOffline extends StatefulWidget {
  const LendersOffline({super.key});

  @override
  State<LendersOffline> createState() => _LendersOfflineState();
}

class _LendersOfflineState extends State<LendersOffline> {
  var totalAmount = 0;
        ...
        children: [
          ...
          SizedBox(
              ...
              child: FutureBuilder<List<Map<String, dynamic>>>(
                  future: DatabaseMethod().getAllTransactionsGave(),
